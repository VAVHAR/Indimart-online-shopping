...
.price-details h6{
   ...
   <body class="main-layout">
                              ...
                              <li class="nav-item dropdown">
                                ...
                                <?php
                                    if(isset($_SESSION['username']))
                                    {
                                       ...
                                       echo '<a class="nav-link dropdown-toggle text-white" href="#" id="navbarDropdown" role="button" data-mdb-toggle="dropdown" data-bs-toggle="dropdown" aria-expanded="false"> <i class="fas fa-user mx-1"></i>Welcome, '.$_SESSION['username'].'
               ...
               <div class="col-12">                   
                 <nav class="navbar bg-body-tertiary navbar-expand-lg" style="background-color:#e9ecef;border-radius:8px;margin: 10px 0px">
                     <div class="container-fluid">
                        ...
                        <input class="form-control me-2" type="search" name="search_query" id="search" placeholder="Search for Products" aria-label="Search" style="border-color:red;">
                        &nbsp;&nbsp;
    ...
    <h2 class="text-center" style="margin:17px;font-weight:700;color:red;font-family: Raleway;">Search Result</h2>
...
<div class="row justify-content-center">
                    ...
                    {
                       $products = $customerobj ->searchpro($_POST);
...
<div class="row justify-content-center">
                    ...
                    ?>
                        <div class="col-lg-3">
                            ...
                            <div class="product">
                                <figure><img src="../images/<?php echo $product['pimage']; ?>" alt="#"/></figure>
                            </div>
                            <h3><?php echo $product['pname']; ?></h3>
                            <div class="d-flex justify-content-between align-items-center mt-3"> 
                                <div>
                                    <span>Price: <?php echo $product['pprice']; ?></span>
                                </div>
                                <div>
                                    <button class="btn-danger"><i class="fa-solid fa-cart-plus"></i></button>
                                </div>
                            </div>     

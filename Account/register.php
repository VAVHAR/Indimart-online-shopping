...
<head>
	...
	<title>Indimart Register Page</title>
		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					<div class="brand">
						<img src="../images/logo_1.png" alt="bootstrap 4 login page">
					</div>
					<div class="text-center">
						<h3 class="text-muted">Indimart<span>&reg;</span></h3>
					</div>
					<div class="card fat">
						<div class="card-body">
							<h4 class="card-title">Register</h4>
							<form method="POST" class="my-login-validation" novalidate="" action="<?php $_PHP_SELF ?>">
					...
					<div class="footer">
						Copyright &copy; 2017 &mdash; IndiMart 
					</div>
				</div>
			</div>
		</div>
